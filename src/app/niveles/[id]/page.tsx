...
export default function NivelPage() {
  ...
  const { completarNivel } = useProgreso();
  ...
  const avanzarFase = useCallback(() => {
    ...
    if (nextIndex < FASES_ORDEN.length) {
      ...
      completarNivel(nivelId, estrellas);
      router.push('/progreso');
    }
  }, [faseActual, faseIndex, router, nivelId, completarNivel]);

  // faseData solo para propiedades comunes (dialogoPolya)
