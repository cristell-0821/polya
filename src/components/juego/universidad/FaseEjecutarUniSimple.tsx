// src/components/juego/universidad/FaseEjecutarUniSimple.tsx
'use client';
...
export default function FaseEjecutarUniSimple({
  respuestaCorrecta,
  tolerancia,
  intentosMaximos,
  dialogoPolya,
  ...
  const verificarRespuesta = () => {
    ...
    const esCorrecto = diffX <= tolerancia;

    const intentoStr = `Intento ${nuevoIntento}: x=${valX}`;
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          onKeyDown={(e) => e.key === 'Enter' && inputValido && verificarRespuesta()}
        />
      </div>
            ...
            {puntaje > 0 ? (
              <>
                ...
                <p className="text-green-700 font-bold text-xl">
                  ¡Respuesta correcta! x={respuestaCorrecta.x}
                </p>
